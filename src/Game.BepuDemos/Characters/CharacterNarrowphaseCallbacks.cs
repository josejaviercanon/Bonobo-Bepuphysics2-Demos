...
/// <summary>
///     Implements simple callbacks to inform the character controllers system of created contacts
///     (upstream <c>CharacterNarrowphaseCallbacks</c>, BepuPhysics2, Apache-2.0, Ross Nordby).
/// </summary>
